...
# Запуск отсюда напрямую тихо создаёт директории с буквальным именем "/c/Users/Татьяна"
...
# WP-273 0.29.4 R6.1 fix (issue #271): runtime-резолв вместо build-time /d/iwe — как в strategist.sh.
