...
2. **Итоги вчера** — `git log --since="yesterday 00:00" --until="today 00:00"` по ВСЕМ репо в `/d/iwe/`:
   - Группировка по репо
...
- ✅ Все решения принимай по skill /day-open (`${IWE_WORKSPACE:-/d/iwe}/.claude/skills/day-open/SKILL.md`)
...
- HUB: `/d/iwe/{{GOVERNANCE_REPO}}/current/`
- SPOKES: `/d/iwe/*/WORKPLAN.md`
- MEMORY: `~/.claude/projects/{{CLAUDE_PROJECT_SLUG}}/memory/`
- Skill: `/d/iwe/.claude/skills/day-open/SKILL.md`
- Templates: `~/.claude/projects/{{CLAUDE_PROJECT_SLUG}}/memory/templates-dayplan.md`
- Scaffold: `/d/iwe/scripts/day-open-scaffold.sh`
- Extensions: `/d/iwe/extensions/day-open.before.md`, `.after.md`, `.checks.md`
