...
# issue #217: прямая подстановка /c/Users/Татьяна -> $HOME делает восстановление
...
if [ -f "$EXOCORTEX_SRC/CLAUDE.md" ]; then
    run "sed 's|/c/Users/Татьяна|$HOME_SED_SAFE|g' \"$EXOCORTEX_SRC/CLAUDE.md\" > \"$WORKSPACE_DIR/CLAUDE.md\""
